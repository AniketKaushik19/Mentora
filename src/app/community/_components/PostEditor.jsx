    ...
    const onSubmit=async(data , action , silent=false)=>{
       try {
          const postData={
              ...
              scheduledFor:data.scheduledFor ? new Date(data.scheduledFor).getTime():
              undefined,
          }
          ...
          if(mode==="edit" && initialData?._id){
            ...
            resultId=await updatePost({
             ...
             //Create new post(will auto-update exisitng draft if needed
  ...
  return (
    <div className='min-h-screen bg-slate-900 text-white'>
        ...
        <PostEditorHeader
           ...
           onBack={()=>router.push("/community/dashboard")}
        />
