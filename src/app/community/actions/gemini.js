...
`;
        ...
        if (error.message?.includes("API key")) {
            return {
                success: false,
                error: "AI serivce configuration erro . Please try again later."
            }
        }
        if (error.message?.includes("quota") || error.message?.includes("limit")) {
            return {
                success: false,
                error: "AI service is temporarily unavailable . Please try again after sometime."
            }
        }
        return {
            success: false,
...
export async function improveContent(currentContent,
