...
const PostPage = ({params}) => {
  ...
  const {mutate :addComment , isLoading:isSubmittingComment}=useConvexMutation(api.comments.addComment)
    ...
    <div className='min-h-screen bg-slate-900 text-white'>
      ...
      <div className='max-w-4xl mx-auto px-6 py-8'>
         <article className='space-y-8'>
          ...
          {/* //Header post  */}
           <div className='space-y-4'>
               <h1 className='text-4xl md:text-5xl font-bold gradient-text-primary'>{post.title}</h1>
                      ...
                      <div className='relative w-12 h-12'>
                         {post.author.imageUrl ?(
                          ...
                          />
                           ...
                           <div className='w-full h-full rounded-full bg-graident-to-br from-purple-600 to-blue-600 flex items-center justify-center text-lg font-bold'>
           ...
           {/* //Post Content  */}
           <div className='prose prose-lg max-w-none prose-invert prose-purple' dangerouslySetInnerHTML={{__html:post.content}}/> 
         ...
         <div className='mt-12 space-y-6'>
            ...
            {currentUser ? <Card className={"card-glass"}>
                <CardContent className={"p-6"}>
                    ...
                    >
                      ...
                      <div className='flex items-center justify-between'>
                        <p className='text-xs text-shadow-slate-500'>
